...
public class GrobDTOWithoutGeom {
    private Integer fid;
    ...
    public GrobDTOWithoutGeom(Integer fid, String source, String source1, String source2, String source3, String source4, String source5, String source6, String source7, String redniBroj, String grobnica, String brojLezaja, String groblje, Integer fk) {
        this.fid = fid;
        this.source = source;
